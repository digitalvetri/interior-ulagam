CREATE TYPE "public"."customer_activity_type" AS ENUM('call', 'whatsapp', 'note', 'site_visit', 'meeting', 'stage_change', 'project_created', 'payment_received', 'quote_sent', 'follow_up');--> statement-breakpoint
CREATE TYPE "public"."customer_health_status" AS ENUM('hot', 'healthy', 'at_risk', 'inactive');--> statement-breakpoint
...
ALTER TABLE "customer_activities" ADD CONSTRAINT "customer_activities_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "customer_activities" ADD CONSTRAINT "customer_activities_performed_by_users_id_fk" FOREIGN KEY ("performed_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "wa_messages" ADD CONSTRAINT "wa_messages_lead_id_leads_id_fk" FOREIGN KEY ("lead_id") REFERENCES "public"."leads"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "customer_activities_tenant_type_idx" ON "customer_activities" USING btree ("tenant_id","type");--> statement-breakpoint
...
CREATE INDEX "wa_messages_tenant_thread_idx" ON "wa_messages" USING btree ("tenant_id","thread_id");--> statement-breakpoint
CREATE INDEX "wa_messages_lead_idx" ON "wa_messages" USING btree ("lead_id");