...
import {
  Plus, Search, ChevronDown, Trash2, FileText, PackageCheck,
} from 'lucide-react';
import {
  Dialog,
  DialogContent,
...
const STATUS_STYLES: Record<POStatus, { bg: string; fg: string; border: string }> = {
  ...
  complete:     { bg: 'var(--mint-mist)',               fg: 'var(--forest-deep)',    border: 'rgba(14,127,110,0.24)' },
      ...
      <div className="premium-card overflow-hidden">
        ...
        {!loading && !fetchError && orders.length === 0 && (
          <div className="flex flex-col items-center justify-center gap-3 p-14 text-center">
            ...
            >
              <FileText className="h-5 w-5" style={{ color: 'var(--forest)' }} strokeWidth={1.75} />
            </div>
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <span className="text-right font-semibold tnum" style={{ color: 'var(--forest-deep)' }}>
