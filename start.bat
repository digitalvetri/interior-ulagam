@echo off
title Shadow Market Dev Starter
...
start "Shadow Market Backend" cmd /k "cd /d "%~dp0backend" && python -m uvicorn app.main:app --reload --port 8001"
...
start "Shadow Market Frontend" cmd /k "cd /d "%~dp0frontend" && npm run dev"
