# Shadow Market — Phased Implementation Plan (PRP v1.2 → Code)

## Context

**Why this plan exists**
Shadow Market's spec (`PRPs/shadow-market-prp.md`) was just revised to v1.2. The revisions capture three things the current code does not:
...
3. Browser: log in as `admin@shadow-market.com / Admin1234`
